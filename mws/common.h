...
//event operation
extern void do_event(struct epoll_event *evp, int lfd, int efd, char* root_path, workers *handler, workers *sender, workers* writer);
extern int runtime(void *args, workers* handler, workers* writer);
